...
- Read issues, PRs, comments, review threads, and checks through GitHub tools.
- Treat local commits, comments, pushes, PR creation, PR body updates, and review-thread changes as approval-gated side effects.
