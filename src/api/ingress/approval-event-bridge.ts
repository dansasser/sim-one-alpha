import type { NormalizedMessageEvent } from '../../core/types/core.js';
import type { CodingApprovalActionType } from '../../engine/workers/coding-worker/approvals/approval-types.js';
import { createCodingWorkerEvent, type CodingWorkerEvent } from '../../engine/workers/coding-worker/events/coding-worker-events.js';
import type { CodingProgressReporter } from '../../engine/workers/coding-worker/events/progress-reporter.js';
import type { ApprovalIngress } from '../../api/ingress/approval-types.js';
