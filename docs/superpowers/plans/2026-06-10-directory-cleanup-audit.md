...
- `pnpm run build` passed and found 1 agent plus 4 workflows.
- `pnpm run smoke:http` passed.
...
- `pnpm test` passed with 91 tests.
- `pnpm run typecheck` passed.
- `pnpm run build` passed and found 1 agent plus 4 workflows.
- `pnpm run smoke:http` passed.
...
- `pnpm test` passed with 91 tests after moving the loader.
- `pnpm run typecheck` passed.
- `pnpm run build` passed and found 1 agent plus 4 workflows.
- `pnpm run smoke:http` passed.
