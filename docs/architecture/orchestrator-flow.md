...
The Ratatui TUI enters this same durable chat path through `/api/chat/events` as connector `tui`; see `docs/architecture/tui-cli-session-flow.md` for CLI, TUI, slash-command, and session-switching details.
